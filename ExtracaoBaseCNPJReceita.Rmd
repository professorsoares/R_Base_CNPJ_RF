...
# t(dados_Layout_por_tipo$COLUNA)

# t(dados_Layout_por_tipo$COLUNAFIM)
...
as_tibble %>% 
    filter(CODIGO_NATUREZA_JURIDICA=="3069")
...
```{r}
df_Fundacao %>% 
    filter(CODIGO_NATUREZA_JURIDICA=="3069", UF=="RJ") %>% 
      write_csv("D:/_FUNDACAO/output/_df_CNPJ1_full1_Fund.csv")
