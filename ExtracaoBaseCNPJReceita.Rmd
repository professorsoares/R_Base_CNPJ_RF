...
#Utiliza o documento "dadosCNPJ01Amostra100.txt" com o esqueleto das informações levantadas no chunk anterior. A fim de que seus dados respeitasse a quantidade de caracter para cada coluna. E o adiciona a um data frame, para melhor visualização
```{r}
